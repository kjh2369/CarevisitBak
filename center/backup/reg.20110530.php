...
window.onload = function(){
	...
	var kind_2  = document.getElementById('kind_2').checked;
	var kind_3  = document.getElementById('kind_3').checked;
	...
	_show_tbody_layer('tbody2', 'tbody_layer_2', kind_2);
	_show_tbody_layer('tbody3', 'tbody_layer_3', kind_3);
				...
				<table class="my_table" style="width:100%; border-bottom:0px;">
					...
					<tbody>
						<tr>
							...
							<?
								if ($editMode){
								?>	<input name="mCode" type="text" value="<?=$mCode;?>" maxlength="15" class="no_string" style="width:120px;" onKeyDown="__onlyNumber(this);" onFocus="this.select();" onChange="return _exist('mCode');" tag="승인번호를 입력하여 주십시오.">	<?
								}else{
						...
						<tr>
							<th colspan="2">케어비지트 사용일자</th>
							<td style="border-right:none;">
								<input name="contDate" type="text" value="<?=$contDate;?>" maxlength="8" class="date" style="width:70px;" onKeyDown="__onlyNumber(this);" onFocus="__replace(this, '-', '');" onBlur="__getDate(this);" onClick="_carlendar(this);" tag="케어비지트 처음 사용일자를 입력하여 주십시오.">
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th colspan="2">
								...
								<div class="help" onmouseover="_show_help(this, '기본급 및 각 수당(공휴일, 기관약정휴일이 유급인 경우)을 산출하기 위한 기준시간과 시급을 입력합니다.');" onmouseout="_hidden_help();"></div>
							</th>
							<td class="last">
						...
						<tr>
							<th class="head" rowspan="2">공휴일</th>
							<th>
								<div class="help_left">인정여부</div>
								<div class="help" onmouseover="_show_help(this, '일요일, 선거일등 법으로 고시된 날(공휴일)을 급여처리시 휴일로 간주하여 계산할 지의 여부.');" onmouseout="_hidden_help();"></div>
							</th>
							<td class="last">
						...
						<tr>
							<th>
								...
								<div class="help" onmouseover="_show_help(this, '공휴일을 일근무기준시간으로 일급을 지급할 것인지의 여부.');" onmouseout="_hidden_help();"></div>
							</th>
							<td class="last">
						...
						<tr>
							<td class="last bottom" colspan="3">
								<p style="text-align:justify; line-height:1.3em; padding:5px;">
									...
									<span style="padding-left:11px;">휴일로 처리됩니다.</span><br><br>
									<span>※법정공휴일 여부를 "<font color="ff0000">유</font>"로 하고 급여여부를 "<font color="ff0000">무</font>"로 했을 경우</span><br>
									<span style="padding-left:12px;">법정공휴일에 근무를 하게되면은 휴일수당을 지급하여야 합니다.</span>
								</p>
							</td>
						</tr>
					</tbody>
