<?
	...
	if ($rowCount > 0){
		...
		for($i=0; $i<$rowCount; $i++){
			...
			$day_work_hour[$row['m00_mkind']] = $row['m00_day_work_hour'];
			$day_hourly[$row['m00_mkind']]    = $row['m00_day_hourly'];

			if ($day_hourly[$row['m00_mkind']] == 0) $day_hourly[$row['m00_mkind']] = $min_hourly;
...
window.onload = function(){
	...
	if (use2){
		set_show_tbody_layer('2', 6, kind_2_1);
		set_show_tbody_layer('3', 6, kind_2_2);
		set_show_tbody_layer('4', 6, kind_2_3);
		set_show_tbody_layer('5', 6, kind_2_4);
	}
		...
		<tr>
			<td style="vertical-align:top;">
				<table class="my_table" style="width:100%; border-bottom:0px;">
					...
					<tbody>
						<tr>
							<th colspan="2">가맹점기호</th>
							<td style="border-right:none;">
							<?
								if ($editMode){
								?>	<input name="mCode" type="text" value="<?=$mCode;?>" maxlength="15" style="width:120px;" onFocus="this.select();" onChange="return _exist('mCode');" tag="승인번호를 입력하여 주십시오.">	<?
								}else{
						...
						<tr>
							<th colspan="2">가맹점명</th>
							<td style="border-right:none;">
								<input name="storeNm" type="text" value="<?=$storeNm;?>" maxlength="10" style="width:100%;" tag="가맹점명을 입력하여 주십시오.">
							</td>
						</tr>
						<tr>
							<th colspan="2">개설일자</th>
							<td style="border-right:none;">
								<input name="openDt" type="text" value="<?=$openDt;?>" maxlength="8" class="date" onKeyDown="__onlyNumber(this);" onFocus="__replace(this, '-', '');" onBlur="__getDate(this);" onClick="_carlendar(this);">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-right:none;">
								<input name="cTel" type="text" value="<?=$cTel;?>" maxlength="11" class="phone" onKeyDown="__onlyNumber(this)" onFocus="__replace(this, '-', '');" onBlur="__getPhoneNo(this);" tag="가맹점전화번호를 입력하여 주십시오.">
							</td>
						</tr>
						<tr>
							<th colspan="2">FAX번호</th>
							<td style="border-right:none;">
								<input name="faxNo" type="text" value="<?=$faxNo;?>" maxlength="11" class="phone" onKeyDown="__onlyNumber(this)" onFocus="__replace(this, '-', '');" onBlur="__getPhoneNo(this);" tag="FAX번호를 입력하여 주십시오.">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-right:none;">
								<input name="email" type="text" value="<?=$email;?>" maxlength="30" style="width:100%;">
							</td>
						</tr>
						<tr>
							<th colspan="2">
			...
			<td style="vertical-align:top;">
				<table class="my_table" style="width:100%; border-bottom:0px;">
					...
					<tbody>
						<tr>
							...
							<td style="border-right:none;" colspan="3">
								<input name="kind_1" type="checkbox" value="Y" class="checkbox" style="margin-right:0;" <? if($centerGubun[0] == 'Y'){echo 'checked';} ?> onClick="_show_tbody_layer('tbody1', 'tbody_layer_1', this.checked);">재가
								<?
									if ($is_use_center[2]){?>
					...
					<tbody id="tbody1">
						<tr>
							<th rowspan="10" style="padding:0; text-align:center;">재</br>가</th>
							<th>승인번호</th>
							<td style="border-right:none;" colspan="3">
								<input name="code0" type="text" value="<?=$code1[0];?>" maxlength="15" class="phonerr" style="width:120px;" onKeyDown="__onlyNumber(this);" onFocus="this.select();" tag="재가요양기관의 승인번호를 입력하여 주십시오.">
							</td>
						</tr>
						<tr>
							<th>기관명칭</th>
							...
							if ($_SESSION['userLevel'] != 'A'){?>
								<tr>
									...
									<td style="border-right:none;" colspan="2">
										<select name="bankName0" style="width:auto;">
										<?
											for($i=0; $i<$bankListCount; $i++){
											?>
												<option value="<?=$bankList[$i]['code'];?>" title="<?=$bankList[$i]['name'];?>" <? if($bankList[$i]['code'] == $bankName[0]){?>selected<?} ?>><?=$bankList[$i]['name'];?></option>
											<?
											}
										?>
										</select>
								...
								<tr>
									<th>계좌번호</th>
									<td style="border-right:none;" colspan="2">
										<input name="bankNo0" type="text" value="<?=$bankNo[0];?>" maxlength="30" style="width:100%;">
									</td>
								</tr>
								<tr>
									<th>예금주명</th>
									<td style="border-right:none;" colspan="2">
										<input name="bankDepos0" type="text" value="<?=$bankDepos[0];?>" maxlength="30" style="width:100%;">
									</td>
								</tr>
								<tr>
									<th colspan="2">
										<div class="help_left">소정근로시간/시급</div>
									...
									<td class="last">
										<input name="day_work_hour0" type="text" value="<?=$day_work_hour[0];?>" maxlength="3" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시간을 입력하여 주십시오."> /
										<input name="day_hourly0"    type="text" value="<?=number_format($day_hourly[0]);?>" tag="<?=$min_hourly;?>" maxlength="8" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시급을 입력하여 주십시오.">
									</td>
								</tr><?
							}else{?>
								<input name="bankName0"      type="hidden" value="<?=$bankName[0];?>">
								<input name="bankNo0"        type="hidden" value="<?=$bankNo[0];?>">
								<input name="bankDepos0"     type="hidden" value="<?=$bankDepos[0];?>">
								<input name="day_work_hour0" type="hidden" value="<?=$day_work_hour[0];?>">
								<input name="day_hourly0"    type="hidden" value="<?=$day_hourly[0];?>"><?
							}
						?>
					</tbody>
					<?
						...
						if ($is_use_center[2]){?>
							<tbody id="tbody2">
								<tr>
									<th rowspan="<?=$rowspan1;?>" style="padding:0; text-align:center;">바</br>우</br>처</th>
									<th rowspan="<?=$rowspan2;?>" class="padding_no"><input name="kind_2_1" type="checkbox" class="checkbox" value="Y" <? if($gubun_1[1] == 'Y'){?>checked<?} ?> onClick="set_show_tbody_layer('2', 6, this.checked);"><span style="margin-left:-5px;">가사간병</span></th>
									<th>승인번호</th>
								...
								<?
									if ($_SESSION['userLevel'] != 'A'){?>
										<tr>
											<th>입금은행</th>
											<td id="tbody_row_2_4" style="border-right:none;">
												<select name="bankName1" style="width:auto;">
												<?
													for($i=0; $i<$bankListCount; $i++){
													?>
														<option value="<?=$bankList[$i]['code'];?>" title="<?=$bankList[$i]['name'];?>" <? if($bankList[$i]['code'] == $bankName[1]){?>selected<?} ?>><?=$bankList[$i]['name'];?></option>
													<?
													}
												?>
												</select>
										...
										<tr>
											<th>계좌번호</th>
											<td id="tbody_row_2_5" style="border-right:none;">
												<input name="bankNo1" type="text" value="<?=$bankNo[1];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>예금주명</th>
											<td id="tbody_row_2_6" style="border-right:none;">
												<input name="bankDepos1" type="text" value="<?=$bankDepos[1];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>시간/시급</th>
											<td class="last">
												<input name="day_work_hour1" type="text" value="<?=$day_work_hour[1];?>" maxlength="3" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시간을 입력하여 주십시오."> /
												<input name="day_hourly1"    type="text" value="<?=number_format($day_hourly[1]);?>" tag="<?=$min_hourly;?>" maxlength="8" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시급을 입력하여 주십시오.">
											</td>
										</tr><?
									}else{?>
										<input name="bankName1"      type="hidden" value="<?=$bankName[1];?>">
										<input name="bankNo1"        type="hidden" value="<?=$bankNo[1];?>">
										<input name="bankDepos1"     type="hidden" value="<?=$bankDepos[1];?>">
										<input name="day_work_hour1" type="hidden" value="<?=$day_work_hour[1];?>">
										<input name="day_hourly1"    type="hidden" value="<?=$day_hourly[1];?>"><?
									}
								?>

								<tr>
									<th rowspan="<?=$rowspan2;?>" class="padding_no"><input name="kind_2_2" type="checkbox" class="checkbox" value="Y" <? if($gubun_1[2] == 'Y'){?>checked<?} ?> onClick="set_show_tbody_layer('3', 6, this.checked);"><span style="margin-left:-5px;">노인돌봄</span></th>
									<th>승인번호</th>
								...
								<?
									if ($_SESSION['userLevel'] != 'A'){?>
										<tr>
											<th>입금은행</th>
											<td id="tbody_row_3_4" style="border-right:none;">
												<select name="bankName2" style="width:auto;">
												<?
													for($i=0; $i<$bankListCount; $i++){
													?>
														<option value="<?=$bankList[$i]['code'];?>" title="<?=$bankList[$i]['name'];?>" <? if($bankList[$i]['code'] == $bankName[2]){?>selected<?} ?>><?=$bankList[$i]['name'];?></option>
													<?
													}
												?>
												</select>
										...
										<tr>
											<th>계좌번호</th>
											<td id="tbody_row_3_5" style="border-right:none;">
												<input name="bankNo2" type="text" value="<?=$bankNo[2];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>예금주명</th>
											<td id="tbody_row_3_6" style="border-right:none;">
												<input name="bankDepos2" type="text" value="<?=$bankDepos[2];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>시간/시급</th>
											<td class="last">
												<input name="day_work_hour2" type="text" value="<?=$day_work_hour[2];?>" maxlength="3" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시간을 입력하여 주십시오."> /
												<input name="day_hourly2"    type="text" value="<?=number_format($day_hourly[2]);?>" tag="<?=$min_hourly;?>" maxlength="8" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시급을 입력하여 주십시오.">
											</td>
										</tr><?
									}else{?>
										<input name="bankName2"      type="hidden" value="<?=$bankName[2];?>">
										<input name="bankNo2"        type="hidden" value="<?=$bankNo[2];?>">
										<input name="bankDepos2"     type="hidden" value="<?=$bankDepos[2];?>">
										<input name="day_work_hour2" type="hidden" value="<?=$day_work_hour[2];?>">
										<input name="day_hourly2"    type="hidden" value="<?=$day_hourly[2];?>"><?
									}
								?>

								<tr>
									<th rowspan="<?=$rowspan2;?>" class="padding_no"><input name="kind_2_3" type="checkbox" class="checkbox" value="Y" <? if($gubun_1[3] == 'Y'){?>checked<?} ?> onClick="set_show_tbody_layer('4', 6, this.checked);"><span style="margin-left:-5px;">산모신생아</span></th>
									<th>승인번호</th>
								...
								<?
									if ($_SESSION['userLevel'] != 'A'){?>
										<tr>
											<th>입금은행</th>
											<td id="tbody_row_4_4" style="border-right:none;">
												<select name="bankName3" style="width:auto;">
												<?
													for($i=0; $i<$bankListCount; $i++){
													?>
														<option value="<?=$bankList[$i]['code'];?>" title="<?=$bankList[$i]['name'];?>" <? if($bankList[$i]['code'] == $bankName[3]){?>selected<?} ?>><?=$bankList[$i]['name'];?></option>
													<?
													}
												?>
												</select>
										...
										<tr>
											<th>계좌번호</th>
											<td id="tbody_row_4_5" style="border-right:none;">
												<input name="bankNo3" type="text" value="<?=$bankNo[3];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>예금주명</th>
											<td id="tbody_row_4_6" style="border-right:none;">
												<input name="bankDepos3" type="text" value="<?=$bankDepos[3];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>시간/시급</th>
											<td class="last">
												<input name="day_work_hour3" type="text" value="<?=$day_work_hour[3];?>" maxlength="3" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시간을 입력하여 주십시오."> /
												<input name="day_hourly3"    type="text" value="<?=number_format($day_hourly[3]);?>" tag="<?=$min_hourly;?>" maxlength="8" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시급을 입력하여 주십시오.">
											</td>
										</tr><?
									}else{?>
										<input name="bankName3"      type="hidden" value="<?=$bankName[3];?>">
										<input name="bankNo3"        type="hidden" value="<?=$bankNo[3];?>">
										<input name="bankDepos3"     type="hidden" value="<?=$bankDepos[3];?>">
										<input name="day_work_hour3" type="hidden" value="<?=$day_work_hour[3];?>">
										<input name="day_hourly3"    type="hidden" value="<?=$day_hourly[3];?>"><?
									}
								?>

								<tr>
									<th rowspan="<?=$rowspan2;?>" class="padding_no"><input name="kind_2_4" type="checkbox" class="checkbox" value="Y" <? if($gubun_1[4] == 'Y'){?>checked<?} ?> onClick="set_show_tbody_layer('5', 6, this.checked);"><span style="margin-left:-5px;">장애인활동보조</span></th>
									<th>승인번호</th>
								...
								<?
									if ($_SESSION['userLevel'] != 'A'){?>
										<tr>
											<th>입금은행</th>
											<td id="tbody_row_5_4" style="border-right:none;">
												<select name="bankName4" style="width:auto;">
												<?
													for($i=0; $i<$bankListCount; $i++){
													?>
														<option value="<?=$bankList[$i]['code'];?>" title="<?=$bankList[$i]['name'];?>" <? if($bankList[$i]['code'] == $bankName[4]){?>selected<?} ?>><?=$bankList[$i]['name'];?></option>
													<?
													}
												?>
												</select>
										...
										<tr>
											<th>계좌번호</th>
											<td id="tbody_row_5_5" style="border-right:none;">
												<input name="bankNo4" type="text" value="<?=$bankNo[4];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>예금주명</th>
											<td id="tbody_row_5_6" style="border-right:none;">
												<input name="bankDepos4" type="text" value="<?=$bankDepos[4];?>" maxlength="30" style="width:100%;">
											</td>
										</tr>
										<tr>
											<th>시간/시급</th>
											<td class="last">
												<input name="day_work_hour4" type="text" value="<?=$day_work_hour[4];?>" maxlength="3" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시간을 입력하여 주십시오."> /
												<input name="day_hourly4"    type="text" value="<?=number_format($day_hourly[4]);?>" tag="<?=$min_hourly;?>" maxlength="8" class="number" style="width:50px;" onKeyDown="__onlyNumber(this,'.');" onFocus="this.select();" tag="일근무기준시급을 입력하여 주십시오.">
											</td>
										</tr><?
									}else{?>
										<input name="bankName4"      type="hidden" value="<?=$bankName[4];?>">
										<input name="bankNo4"        type="hidden" value="<?=$bankNo[4];?>">
										<input name="bankDepos4"     type="hidden" value="<?=$bankDepos[4];?>">
										<input name="day_work_hour4" type="hidden" value="<?=$day_work_hour[4];?>">
										<input name="day_hourly4"    type="hidden" value="<?=$day_hourly[4];?>"><?
									}
								?>
							</tbody><?
						}
