<?
	...
	$sql = 'UPDATE t01iljung
			   SET t01_conf_date		= \''.$date.'\'
			,      t01_conf_fmtime		= \''.$_POST['from'].'\'
			,      t01_conf_totime		= \''.$_POST['to'].'\'
			,      t01_conf_soyotime	= \''.$liTime.'\'
			,      t01_yoyangsa_id1		= \''.$memCd1.'\'
			,      t01_yoyangsa_id2		= \''.$memCd2.'\'
			,      t01_yname1			= \''.$_POST['memNm1'].'\'
			,      t01_yname2			= \''.$_POST['memNm2'].'\'
			,      t01_conf_suga_code	= \''.$_POST['sugaCd'].'\'
			,      t01_conf_suga_value	= \''.$_POST['sugaTCost'].'\'
