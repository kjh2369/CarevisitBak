...
<div style="width:900px; padding-top:10px; padding-bottom:5px; text-align:right;">
	<a onClick="_iljungCal();"><img src="../image/btn_calc.png"></a>
	<a onClick="_iljungSubmit();"><img src="../image/btn_save_2.png"></a>
	<!--<a href="#" onClick="_iljungCopy();"><img src="../image/btn_iljung_copy.png"></a>-->
	<a onClick="_iljungDelete();"><img src="../image/btn11.gif"></a>
	<!--<a href="#" onClick="_iljungTest();">테스트</a>-->
	<a onClick="serviceCalendarShow('<?=$_REQUEST['mCode'];?>','<?=$_REQUEST['mKind'];?>','<?=$_REQUEST['calYear'];?>','<?=$_REQUEST['calMonth'];?>','<?=$_REQUEST['mKey'];?>', 's','n','pdf','y')"><img src="../image/btn_001.png"></a>
</div>
...
function _setSuConst(){
	su_const.innerHTML = getHttpRequest('su_const.php?mCode=<?=$_REQUEST["mCode"];?>&mKind=<?=$_REQUEST["mKind"];?>&mKey=<?=$_REQUEST["mKey"];?>&ym=<?=$_REQUEST["calYear"]?><?=$_REQUEST["calMonth"]?>');
}
