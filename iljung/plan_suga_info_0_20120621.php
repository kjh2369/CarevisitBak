			...
			<tr>
				...
				<th class="center bottom clsExtrBath">
					<select id="txtExtraGbn" name="txtExtraGbn" style="width:auto;">
						...
						if ($debug){?>
							<option value="person">개별</option><?
						}?>
						<!--option value="amt">금액</option-->
					</select>
				</th>
				<td class="center bottom last">
					<div id="loExtraPay" style="float:left; width:auto;">
						<input id="txtExtraPay" name="txtExtraPay" type="text" value="0" class="number" style="width:70px;">
					</div>
					<div id="loExtraR" class="clsExtrBath" style="float:left; width:auto;">
						<input id="txtExtraPay1" name="txtExtraPR" type="text" value="<?=$liRate1;?>" rate="<?=$liRate1;?>" amt="0" class="number" style="width:30px;">%&nbsp;&nbsp;/
						<input id="txtExtraPay2" name="txtExtraPR" type="text" value="<?=$liRate2;?>" rate="<?=$liRate2;?>" amt="0" class="number" style="width:30px;">%
					</div><?
					if ($debug){?>
						<div id="loExtraP" class="left" style="float:left; width:auto;">
							<span id="lblExtraPay1" style="font-weight:bold;">0</span>
							<span class="clsExtrBath"> / </span>
							<span id="lblExtraPay2" style="font-weight:bold;" class="clsExtrBath">0</span>
						</div><?
					}?>
				</td>
				<td class="center bottom clsExtrNurs last">&nbsp;</td>
			</tr>
		</tbody>
	</table>
	<div id="loClientIfno"
