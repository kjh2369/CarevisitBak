<?
					...
					<tr>
						...
						<th class=\'head last\'>
							<div style=\'text-align:left; padding-left:5px;\'>
								<span class=\'btn_pack small\'><button type=\'button\'  onclick=\'showPrint("sel");\'>선택출력</button></span>
							</div>
						</th>
						<th class=\'head last\'>
							<div style=\'text-align:left; padding-left:5px;\'>
								<span class=\'btn_pack small\'><button type=\'button\'  onclick=\'showPrint("sel","confirm");\'>선택출력</button></span>
							</div>
						</th>
					    <th class=\'head\' >비고</th>
					</tr>';
	...
	for($i=0; $i<$rowCount; $i++){
		...
		$html .= '<tr>
					...
					<td class=\'left last\'><span class=\'btn_pack small\'><button type=\'button\' onclick=\'showPrint("'.$ed->en($row['c_cd']).'");\'>세부내역서</button></span></td>
					<td class=\'left last\'><span class=\'btn_pack small\'><button type=\'button\' onclick=\'showPrint("'.$ed->en($row['c_cd']).'","confirm");\'>납부확인서</button></span></td>
					<td>&nbsp;</td>
				  </tr>';
