...
?>
<style type="text/css">
	div,td,body {font:9pt/1.5; letter-spacing:-0.8px; color:#000000; line-height:1.3em;}
	td,th{height:25px;}
</style><?
	...
	<table style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td style="<?=$style;?>"><?=$level[$tmpI];?>등급</td>
		...
		<tbody>
			...
			<tr><? 
				if($yymm < '201701'){ ?>
					...
					<td style="<?=$style;?> text-align:left; padding-left:5px;" colspan="2">*급여제공자 성명(인)</td><?
				} ?>
			...
			<tr>
				...
				<td style="<?=$style;?> text-align:left; padding-left:5px;" colspan="3"><?=nl2br(StripSlashes($R['comment']));?></td>
			</tr>
		</tbody>
	</table>
	</div><?
