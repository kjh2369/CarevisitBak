...
<?
	...
	*/
	$closing_yn = $conn->get_closing_act($_POST["mCode"], $_POST["calYear"].$_POST["calMonth"]);
	...
	*/
	...
	if ($workType == 'modify'){
		...
		echo "opener.location.replace('../work/result_detail.php?mode=2&code=".$_POST["mCode"]."&kind=".$_POST["mKind"]."&year=".$_POST['calYear']."&month=".$_POST['calMonth']."&jumin=".$ed->en($_POST["mJuminNo"])."');";
		...
		echo "opener.location.replace('../work/result_detail.php?mode=1&code=".$_POST['mCode']."&kind=".$_POST['mKind']."&year=".$_POST['calYear']."&month=".$_POST['calMonth']."&day=".$_POST['calDay']."');";
