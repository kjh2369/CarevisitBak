<?
	...
	$sql = 'SELECT	jumin, level
			...
			AND		svc_cd = \'0\'
			AND		app_no = \''.$appNo.'\'
			AND		REPLACE(from_dt,\'-\',\'\') <= \''.$fromDt.'\'
			AND		REPLACE(to_dt,\'-\',\'\') >= \''.$fromDt.'\'';
...
<table>
	...
	<tr>
		...
		<th style="border:0.5pt solid BLACK; background-color:#EAEAEA;" colspan="5">변화상태</th>
	</tr>
	<tr>
		...
		<th style="border:0.5pt solid BLACK; background-color:#EAEAEA;" rowspan="2">일상생활<br style="mso-data-placement:same-cell;">함께하기</th>
	...
	for($i=0; $i<$rowCnt; $i++){
		...
		<tr>
			...
			<td style="width:70px; text-align:center; border:0.5pt solid BLACK;"><?=$row['dtl_5'];?>분</td>
			...
			<td style="width:70px; text-align:center; border:0.5pt solid BLACK;"><?=$tmpGbn[$row['dtl_11']];?></td>
		...
		<tr>
			...
			<td style="text-align:left; border:0.5pt solid BLACK;" colspan="8"><?=$row['dtl_10'];?></td>
		</tr><?
