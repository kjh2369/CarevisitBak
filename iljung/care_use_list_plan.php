<?
					...
					<tr>
						...
						<th class=\'head\'>
							<div style=\'text-align:left; padding-left:5px;\'>
								<span class=\'btn_pack small\'><button type=\'button\' style=\'width:52px;\' onclick=\'showPrint("sel");\'>선택출력</button></span>
							</div>
						</th>
	...
	for($i=0; $i<$rowCount; $i++){
		...
		$html .= '<tr>
					...
					<td class=\'left\'><span class=\'btn_pack m\'><button type=\'button\' onclick=\'showPrint("'.$ed->en($row['c_cd']).'");\'>출력</button></span></td>
