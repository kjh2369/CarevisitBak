...
<script type="text/javascript">
	...
	function lfReg(type, code, ssn, yymm, seq, dt){
		var f    = document.f;
		...
		*/
		...
		f.action = '../sugupja/process_counseling_reg.php';
		f.submit();
	}

	//직원 과정상담출력
	function lfShow(code, seq, ssn, mode ,yymm, dt){
...
<table class="my_table" style="width:100%">
	...
	<tbody>
		...
		<tr>
			<th>고객명</th>
			<td><input id="txtClientName" type="text" value="" style="width:100%;"></td>
			<th>상담자</th>
			<td><input id="txtMemberName" type="text" value="" style="width:100%;"></td>
			<th>상담유형</th>
			<td>
				<select id="cboCounselType" style="width:auto;">
					<option value="ALL">전체</option>
					<option value="VISIT">고객방문상담</option>
					<option value="PHONE">전화상담</option>
					<option value="STRESS">불만 및 고충처리</option>
					<option value="CASE">사례관리회의</option>
					<option value="STAT">상태변화일지</option>
				</select>
			</td>
		</tr>
		<tr>
