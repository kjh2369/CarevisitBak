		...
		for($i=0; $i<$client_cnt; $i++){
			...
			**************************************************************/
				...
				if (!empty($row['cltbsr_cnt'])){
					...
					echo '<img src=\'../image/btn_rep_reg.gif\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTBSR","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'작성\'>';
				}
				...
				*/
				/*
					...
					echo '<img src=\'../image/icon_writer.png\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTBSR","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'욕구평가 기록지 작성\'> ';
			...
			**************************************************************/
				...
				if (!empty($row['cltpst_cnt'])){
					...
					echo '<img src=\'../image/btn_rep_reg.gif\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTPST","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'작성\'>';
				}
				*/
				/*
					...
					echo '<img src=\'../image/icon_writer.png\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTPST","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'욕창위험도 평가도구 작성\'> ';
			...
			**************************************************************/
				...
				if (!empty($row['cltddt_cnt'])){
					...
					echo '<img src=\'../image/btn_rep_reg.gif\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTDDT","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'작성\'>';
				}
				*/
				/*
					...
					echo '<img src=\'../image/icon_writer.png\' style=\'cursor:pointer;\' onclick=\'_report_reg("'.$client[$i]['k_cd'].'","30","30_10_10_CLTDDT","'.date('Ym').'","0","'.$ed->en($client[$i]['c_cd']).'");\' alt=\'낙상위험도 평가도구 작성\'> ';
