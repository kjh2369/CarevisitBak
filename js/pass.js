...
document.write('<div id="bLayer" style="z-index:0; filter:progid:DXImageTransform.Microsoft.Alpha( Opacity=50, FinishOpacity=0, Style=0, StartX=0,  FinishX=100, StartY=0, FinishY=100); background-color:black; position:absolute; top:0px; left:0px; height:0px; width:0px;"></div>');
document.write('<div id="passLayer" style="z-index:1; left:0; top:0; position:absolute; color:#000000;">');
document.write('	<table id="passTable" style="width:220px; height:60px; background-color:#ffffff; display:none;">');
document.write('	<tr>');
document.write('	<td class="noborder" style="width:10px;"></td>');
document.write('	<td class="title" style="width:210px;">비밀번호 변경</td>');
document.write('	</tr>');
document.write('	<tr>');
...
document.write('		<tr>');
document.write('		<td style="width:45%; border:0px; border-bottom:1px dotted #cccccc; text-align:left; padding-left:15px;">현재 비밀번호</td>');
document.write('		<td style="width:55%; border:0px; border-bottom:1px dotted #cccccc; text-align:left;"><input name="nowPass" type="text"></td>');
document.write('		</tr>');
document.write('		<tr>');
document.write('		<td style="border:0px; border-bottom:1px dotted #cccccc; text-align:left; padding-left:15px;">새 비밀번호</td>');
document.write('		<td style="border:0px; border-bottom:1px dotted #cccccc; text-align:left;"><input name="newPass1" type="text"></td>');
document.write('		</tr>');
document.write('		<tr>');
document.write('		<td style="border:0px; border-bottom:1px dotted #cccccc; text-align:left; padding-left:15px;">비밀번호 확인</td>');
document.write('		<td style="border:0px; border-bottom:1px dotted #cccccc; text-align:left;"><input name="newPass2" type="text"></td>');
document.write('		</tr>');
document.write('		<tr>');
document.write('		<td style="border:0px; padding-left:5px;" colspan="2">');
