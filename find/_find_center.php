...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		switch(opener.mode){
			case '1':
				$('#lblTitle').text('SMS 기관찾기');
				break;

			case '11':
				$('#lblTitle').text('스마트폰 기관찾기');
				break;

			case '21':
				$('#lblTitle').text('은행업무 기관찾기');
				break;

			case '31':
				$('#lblTitle').text('지사/기관연결');
				break;
			...
			case '51':
				$('#lblTitle').text('모바일 기관찾기');
				break;

			case '61':
				$('#lblTitle').text('회계세무 기관찾기');
				break;

			case '62':
				$('#lblTitle').text('인사노무 기관찾기');
				break;
			...
			case '64':
				$('#lblTitle').text('재무회계 커뮤니티 기관찾기');
				break;

			case '97':
				$('#lblTitle').text('사용중인 기관찾기');
				break;
