<?
	...
	header( "Content-Disposition: attachment; filename=".$myF->euckr("표준(신규계약)-재가지원 계약서").".xls" );
	header( "Content-Description: ".$myF->euckr("표준(신규계약)-재가지원 계약서"));
	...
	$excel = $excel->load('./doc/kacold_contract.xlsx');
