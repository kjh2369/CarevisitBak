...
class MYPDF extends MY_PDF/*PDF_Korean*/
{
	...
	function drawHeader(){
		...
		$this->Cell(20,$this->rowHeight,'우편번호',1,0,'L',true);
		...
		if($this->gbn == '3'){
			...
			if($this->gbn == '0'){
				...
				$this->Cell(162,$this->rowHeight,'□1등급  □2등급  □3등급  □일반',1,1,'L');				
			}
		}
		$this->SetX($this->left);
		...
		if($this->gbn == '3'){
			...
			if($this->gbn == '0'){
				switch($this->level_gbn){
					case 1:
						$this->Text(35.6, 99.2, 'v');
						break;
					case 2:
						$this->Text(55.7, 99.2, 'v');
						break;
					case N:
						$this->Text(75.6, 99.2, 'v');
						break;
					case 9:
						$this->Text(87.3, 99.2, 'v');
		...
		switch($this->family_gbn){
			case 1:
				$this->Text(35.6, 107.2, 'v');
				break;
			case 2:
				$this->Text(47.3, 107.2, 'v');
				break;
			case 3:
				$this->Text(65.2, 107.2, 'v');
				break;
			case 4:
				$this->Text(83.3, 107.2, 'v');
				break;
			case 9:
				$this->Text(98, 107.2, 'v');
				break;
		}
