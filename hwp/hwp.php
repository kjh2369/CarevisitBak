<?
	...
	$author = "(주)굿이오스";
	$center_nm = "샘플 센터명";
	$print_dt = date('Y.m.d H:i:s', mktime());
	...
	$contents  = '	<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
					<HWPML Style="embed" SubVersion="7.0.0.0" Version="2.7">
						...
						<BODY>
							<SECTION Id="0">
								<P ColumnBreak="false" PageBreak="false" ParaShape="13" Style="0">
									<TEXT CharShape="1">
										<SECDEF CharGrid="0" FirstBorder="false" FirstFill="false" LineGrid="0" OutlineShape="1" SpaceColumns="1134" TabStop="8000" TextDirection="0" TextVerticalWidthHead="0">
											<STARTNUMBER Equation="0" Figure="0" Page="0" PageStartsOn="Both" Table="0"/><HIDE Border="false" EmptyLine="false" Fill="false" Footer="false" Header="false" MasterPage="false" PageNumPos="false"/>
											<PAGEDEF GutterType="LeftOnly" Height="84188" Landscape="0" Width="59528"><PAGEMARGIN Bottom="1417" Footer="1417" Gutter="0" Header="0" Left="5669" Right="5669" Top="7087"/></PAGEDEF>
											<FOOTNOTESHAPE>
												<AUTONUMFORMAT SuffixChar=")" Superscript="false" Type="Digit"/>
												<NOTELINE Color="65536" Length="5cm" Type="Solid" Width="0.12mm"/>
											...
											<ENDNOTESHAPE>
												<AUTONUMFORMAT SuffixChar=")" Superscript="false" Type="Digit"/>
												<NOTELINE Color="19981200" Length="14692344" Type="Solid" Width="0.12mm"/>
											...
											<PAGEBORDERFILL FillArea="Paper" FooterInside="false" HeaderInside="false" TextBorder="true" Type="Even">
												<PAGEOFFSET Bottom="1417" Left="1417" Right="1417" Top="1417"/></PAGEBORDERFILL>
										...
										<FOOTER ApplyPageType="Both"><PARALIST HasNumRef="false" HasTextRef="false" LineWrap="Break" LinkListID="0" LinkListIDNext="0" TextDirection="0" TextHeight="1417" TextWidth="48190" VertAlign="Bottom"><P ParaShape="12" Style="0">
											<TEXT CharShape="1"><CHAR>'.$center_nm.'</CHAR></TEXT></P></PARALIST>
										</FOOTER>
										<TABLE BorderFill="1" CellSpacing="0" ColCount="1" PageBreak="Cell" RepeatHeader="true" RowCount="1">
											<SHAPEOBJECT InstId="1716141120" Lock="false" NumberingType="Table" ZOrder="5">
												<SIZE Height="2848" HeightRelTo="Absolute" Protect="false" Width="29923" WidthRelTo="Absolute"/>
											...
											<ROW>
												<CELL BorderFill="8" ColAddr="0" ColSpan="1" Dirty="false" Editable="false" HasMargin="false" Header="false" Height="2848" Protect="false" RowAddr="0" RowSpan="1" Width="29923">
													<PARALIST LineWrap="Break" LinkListID="0" LinkListIDNext="0" TextDirection="0" VertAlign="Center">
														<P ParaShape="13" Style="0"><TEXT CharShape="5"><CHAR>'.$title.'</CHAR></TEXT></P>
													</PARALIST>
												</CELL>
											</ROW>
										</TABLE>
	...
	if (file_exists('test.hml')) unlink('test.hml');
	...
	header('Content-Type:application/hml');
