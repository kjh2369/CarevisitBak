...
<script type="text/javascript">
	...
	function lfSearch(){
		...
		$.ajax({
			type :'POST'
		,	url  :'./medical_doctor_connect_search.php'
		,	data :{
				'licenceNo' : $('#txtLicenceNo').val(),
				'doctorNm' : $('#txtDoctorNm').val(),
	...
	function lfReg(licence_no,m_org_no,from){
		
		
		var url = './medical_doctor_connect_reg.php';
	...
	function lfDel(licence_no,m_org_no,from){
		
		if (!confirm('삭제된 데이타는 복구가 불가능합니다. 정말로 삭제하시겠습니까?')) return;

		$.ajax({
			type :'POST'
		,	url  :'./medical_doctor_connect_delete.php'
		,	data :{
				'orgNo':licence_no
			,	'mdOrgNo':m_org_no
			,	'fromDt':from
...
<div class="title title_border" style="width:100%;">
	<div style="float:left; width:auto;">의료기관의사 연결</div>
...
<table class="my_table" style="width:100%;">
	...
	<tbody>
		<tr>
			...
			<td>
				<input id="txtLicenceNo" type="text" value="" style="width:100%;">
			</td>
			<th class="center">의사명</th>
			<td>
				<input id="txtDoctorNm" type="text" value="" style="width:100%;">
			</td>
