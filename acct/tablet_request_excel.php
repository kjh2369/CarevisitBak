...
<table border="1">
	...
	<tbody><?
		...
		for($i=0; $i<$rowCnt; $i++){
			...
			<tr style="background-color:#<?=$bgcolor;?>;">
				...
				<td style="text-align:center;" ><?=$row['cnt'];?>차</td>
				<td ><?=$row['org_nm'];?></td>
	...
	<tr style="background-color:#<?=$bgcolor;?>;">
		<td  colspan="6" style="font-size:10pt; font-weight:bold;">총 합계</td>
		<td style="font-size:10pt; font-weight:bold; text-align:right;" colspan="4">입금대수 : <?=number_format($DIPO_CNT);?>대 입금액 : <?=number_format($DIPO_TOT);?>원</td>
	</tr>
	<?
		$conn->row_free();
	?>
