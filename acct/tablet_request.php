...
<script type="text/javascript">
	...
	function lfExcel(){
		...
		document.f.action = 'tablet_request_excel.php'; 
		document.f.submit();
	}
...
<div class="title title_border">테블렛 신청내역</div>
				...
				<table class="my_table" style="width:100%;">
					...
					<tbody>
						<tr>
							...
							<th class="center">차수구분</th>
							<td class="center">
								<select id="cboCnt" name="cboCnt" style="width:auto;">
									<!--option value="all" <?if($cboCnt == 'all'){?>selected<?}?>>전체</option-->
