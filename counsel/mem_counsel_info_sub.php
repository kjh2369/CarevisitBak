<table class="my_table my_border_blue" style="width:100%; margin-top:10px;">
	...
	<tbody>
		<tr>
			...
			<th>우편번호</th>
			<td>
				<input id="counsel_postno1" name="counsel_postno1" type="text" value="<?=substr($mem['mem_postno'],0,3);?>" tabindex="21" maxlength="6" class="phone" style="width:60px;" onKeyDown="__onlyNumber(this)" onFocus="this.select();"> 
				<span class="btn_pack small"><button type="button" onClick="lfPostCode('counsel_postno1', 'counsel_addr', 'counsel_addr_dtl');">찾기</button></span>
			</td>
			<th rowspan="3">연락처</th>
			<th>유선</th>
			<td class="">
		...
		<tr>
			<td colspan="2"><input id="counsel_addr" name="counsel_addr" type="text" value="<?=$mem['mem_addr'];?>" tabindex="21" maxlength="20" style="width:100%;" onKeyDown="__enterFocus();" onFocus="this.select();"></td>
			<th>무선</th>
		...
		<tr>
			<td colspan="2"><input id="counsel_addr_dtl" name="counsel_addr_dtl" type="text" value="<?=$mem['mem_addr_dtl'];?>" tabindex="21" maxlength="20" style="width:100%;" onKeyDown="__enterFocus();" onFocus="this.select();">
			<th>e-mail</th>
