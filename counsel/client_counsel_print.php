<?
	...
	require_once('../pdf/pdf_client_table.php');
	...
	*/
	...
	$pdf -> postno = getPostNoStyle($client['client_postno']);						//우편번호
	...
	if($gbn == '3'){
		...
		$col_width_1 = 156;
		if($gbn == 0){
			$row_height_1 = $rowHeight*4-2;
		}else {
			$row_height_1 = $rowHeight*4;
		}
		...
		$pdf->SetXY(14, $height+88+$add_high);
