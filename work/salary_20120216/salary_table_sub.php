<?
		...
		<table class="<?=$my_table;?>" style="<? if($my_table != ''){?>border-bottom:none;<?} ?>" border="<?=$my_border;?>">
			<tbody>
						...
						<table class="<?=$my_table;?>" style="border-bottom:none;" border="<?=$my_border;?>">
							<tbody>
								...
								<tr><?	// 근무시간/기본급
									...
									for($i=0; $i<$mem_cnt; $i++){
										if ($i % $col_cnt == 0) $index ++;?>
										<td id="id_1_<?=$index;?>[]" class="right" style="width:<?=$col_width1;?>px; <? if($index > 1){?>display:none;<?} ?>"><?=number_format($mem[$i]['work_time'], 1);?></td>
				...
				<tr>
					...
					<td class="right" style=""><?=number_format($work_time, 1);?></td>
	...
	?>
		...
		<table border="1">
			<tr>
				<td class="head_c" rowspan="3" >NO</td>
				<td class="head_c" rowspan="3" >성명</td>
				<td class="head_c" rowspan="3" >주민번호</td>
				<td class="head_c" rowspan="3" >입사일자</td>
			...
			?>
			<tr>
				<td class="head_r" style="border-bottom:2px solid #000000;" colspan="4">합계</td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($total_amt) != 0 ? number_format($total_amt) : '';;?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($deduct_amt) != 0 ? number_format($deduct_amt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000; border-right:2px solid #000000;"><?=number_format($diff_amt) != 0 ? number_format($diff_amt) : '';?></td>

				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_basic_pay) != 0 ? number_format($tot_basic_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($work_cnt) != 0 ? number_format($work_cnt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($work_time, 1) != 0 ? number_format($work_time, 1) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($base_pay) != 0 ? number_format($base_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($weekly_cnt) != 0 ? number_format($weekly_cnt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($weekly_pay) != 0 ? number_format($weekly_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($paid_cnt) != 0 ? number_format($paid_cnt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($paid_pay) != 0 ? number_format($paid_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($bath_cnt) != 0 ? number_format($bath_cnt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($bath_pay) != 0 ? number_format($bath_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($nursing_cnt) != 0 ? number_format($nursing_cnt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($nursing_pay) != 0 ? number_format($nursing_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($meal_pay) != 0 ? number_format($meal_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($car_keep_pay) != 0 ? number_format($car_keep_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000; border-right:2px solid #000000;"><?=number_format($bojeon_pay) != 0 ? number_format($bojeon_pay) : '';?></td>

				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_sudang_pay) != 0 ? number_format($tot_sudang_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($prolong_hour) != 0 ? number_format($prolong_hour) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($prolong_pay) != 0 ? number_format($prolong_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($night_hour) != 0 ? number_format($night_hour) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($night_pay) != 0 ? number_format($night_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($holiday_hour) != 0 ? number_format($holiday_hour) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($holiday_pay) != 0 ? number_format($holiday_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($holiday_prolong_hour) != 0 ? number_format($holiday_prolong_hour) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($holiday_prolong_pay) != 0 ? number_format($holiday_prolong_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($holiday_night_hour) != 0 ? number_format($holiday_night_hour) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000; border-right:2px solid #000000;"><?=number_format($holiday_night_pay) != 0 ? number_format($holiday_night_pay) : '';?></td>

				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_ins_pay) != 0 ? number_format($tot_ins_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($pension_amt) != 0 ? number_format($pension_amt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($health_amt) != 0 ? number_format($health_amt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($care_amt) != 0 ? number_format($care_amt) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000; border-right:2px solid #000000;"><?=number_format($employ_amt) != 0 ? number_format($employ_amt) : '';?></td>

				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_tax_pay) != 0 ? number_format($tot_tax_pay) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tax_amt_1) != 0 ? number_format($tax_amt_1) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000; border-right:2px solid #000000;"><?=number_format($tax_amt_2) != 0 ? number_format($tax_amt_2) : '';?></td>

				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($addon_pay_1) != 0 ? number_format($addon_pay_1) : '';?></td>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($rank_pay) != 0 ? number_format($rank_pay) : '';?></td><?
				for($j=0; $j<$addon_count[1]; $j++){?>
					<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_addon[1][$addon_caption[1][$j]['index']]) != 0 ? number_format($tot_addon[1][$addon_caption[1][$j]['index']]) : '';?></td><?
				}?>
				<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($addon_pay_2) != 0 ? number_format($addon_pay_2) : '';?></td><?
				for($j=0; $j<$addon_count[2]; $j++){?>
					<td class="filed_r" style="border-bottom:2px solid #000000;"><?=number_format($tot_addon[2][$addon_caption[2][$j]['index']]) != 0 ? number_format($tot_addon[2][$addon_caption[2][$j]['index']]) : '';?></td><?
				}?>
			</tr><?
			for($i=0; $i<$mem_cnt; $i++){?>
				<tr>
					<td class="head_c"><?=$i+1;?></td>
					<td class="head"><?=$mem[$i]['member_nm'];?></td>
					<td class="filed_c"><?=substr($mem[$i]['member_cd'],0,6);?>-<?=substr($mem[$i]['member_cd'],6,7);?></td>
					<td class="filed_c"><?=$myF->dateStyle($mem[$i]['yipsail'],'.');?></td>
					<td class="filed_r"><?=number_format($mem[$i]['total_amt']) != 0 ? number_format($mem[$i]['total_amt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['deduct_amt']) != 0 ? number_format($mem[$i]['deduct_amt']) : '';?></td>
					<td class="filed_r" style="border-right:2px solid #000000;"><?=number_format($mem[$i]['diff_amt']) != 0 ? number_format($mem[$i]['diff_amt']) : '';?></td>

					<td class="filed_r"><?=number_format($mem[$i]['tot_basic_pay']) != 0 ? number_format($mem[$i]['tot_basic_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['work_cnt']) != 0 ? number_format($mem[$i]['work_cnt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['work_time'], 1) != 0 ? number_format($mem[$i]['work_time']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['base_pay']) != 0 ? number_format($mem[$i]['base_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['weekly_cnt']) != 0 ? number_format($mem[$i]['weekly_cnt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['weekly_pay']) != 0 ? number_format($mem[$i]['weekly_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['paid_cnt']) != 0 ? number_format($mem[$i]['paid_cnt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['paid_pay']) != 0 ? number_format($mem[$i]['paid_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['bath_cnt']) != 0 ? number_format($mem[$i]['bath_cnt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['bath_pay']) != 0 ? number_format($mem[$i]['bath_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['nursing_cnt']) != 0 ? number_format($mem[$i]['nursing_cnt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['nursing_pay']) != 0 ? number_format($mem[$i]['nursing_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['meal_pay']) != 0 ? number_format($mem[$i]['meal_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['car_keep_pay']) != 0 ? number_format($mem[$i]['car_keep_pay']) : '';?></td>
					<td class="filed_r" style="border-right:2px solid #000000;"><?=number_format($mem[$i]['bojeon_pay']) != 0 ? number_format($mem[$i]['bojeon_pay']) : '';?></td>

					<td class="filed_r"><?=number_format($mem[$i]['tot_sudang_pay']) != 0 ? number_format($mem[$i]['tot_sudang_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['prolong_hour']) != 0 ? number_format($mem[$i]['prolong_hour']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['prolong_pay']) != 0 ? number_format($mem[$i]['prolong_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['night_hour']) != 0 ? number_format($mem[$i]['night_hour']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['night_pay']) != 0 ? number_format($mem[$i]['night_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['holiday_hour']) != 0 ? number_format($mem[$i]['holiday_hour']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['holiday_pay']) != 0 ? number_format($mem[$i]['holiday_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['holiday_prolong_hour']) != 0 ? number_format($mem[$i]['holiday_prolong_hour']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['holiday_prolong_pay']) != 0 ? number_format($mem[$i]['holiday_prolong_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['holiday_night_hour']) != 0 ? number_format($mem[$i]['holiday_night_hour']) : '';?></td>
					<td class="filed_r" style="border-right:2px solid #000000;"><?=number_format($mem[$i]['holiday_night_pay']) != 0 ? number_format($mem[$i]['holiday_night_pay']) : '';?></td>

					<td class="filed_r"><?=number_format($mem[$i]['tot_ins_pay']) != 0 ? number_format($mem[$i]['tot_ins_pay']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['pension_amt']) != 0 ? number_format($mem[$i]['pension_amt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['health_amt']) != 0 ? number_format($mem[$i]['health_amt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['care_amt']) != 0 ? number_format($mem[$i]['care_amt']) : '';?></td>
					<td class="filed_r" style="border-right:2px solid #000000;"><?=number_format($mem[$i]['employ_amt']) != 0 ? number_format($mem[$i]['employ_amt']) : '';?></td>

					<td class="filed_r"><?=number_format($mem[$i]['tot_tax_pay']) != 0 ? number_format($mem[$i]['total_amt']) : '';?></td>
					<td class="filed_r"><?=number_format($mem[$i]['tax_amt_1']) != 0 ? number_format($mem[$i]['total_amt']) : '';?></td>
					<td class="filed_r" style="border-right:2px solid #000000;"><?=number_format($mem[$i]['tax_amt_2']) != 0 ? number_format($mem[$i]['tax_amt_2']) : '';?></td>

					<td class="filed_r"><?=number_format($tot_addon_pay[1][$mem[$i]['member_cd']]) != 0 ? number_format($tot_addon_pay[1][$mem[$i]['member_cd']]) : '';?></td>
					<td class="filed_r" <? if($addon_count[1] == 0){?>style="border-right:2px solid #000000;"<?} ?>><?=number_format($mem[$i]['rank_pay']) != 0 ? number_format($mem[$i]['rank_pay']) : '';?></td><?
					for($j=0; $j<$addon_count[1]; $j++){?>
						<td class="filed_r" <? if($i+1==$addon_count[1]){?>style="border-right:2px solid #000000;"<?} ?>><?=number_format($addon_pay[$mem[$i]['member_cd']][1][$addon_caption[1][$j]['index']]) != 0 ? number_format($addon_pay[$mem[$i]['member_cd']][1][$addon_caption[1][$j]['index']]) : '';?></td><?
					}?>
					<td class="filed_r"><?=number_format($tot_addon_pay[2][$mem[$i]['member_cd']]) != 0 ? number_format($tot_addon_pay[2][$mem[$i]['member_cd']]) : '';?></td><?
					for($j=0; $j<$addon_count[2]; $j++){?>
						<td class="filed_r"><?=number_format($addon_pay[$mem[$i]['member_cd']][2][$addon_caption[2][$j]['index']]) != 0 ? number_format($addon_pay[$mem[$i]['member_cd']][2][$addon_caption[2][$j]['index']]) : '';?></td><?
					}?>
				</tr><?
			}
			?>
