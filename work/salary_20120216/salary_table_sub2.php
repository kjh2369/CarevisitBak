<?
	...
	<table style="border-right:0.5pt solid #000000;">
		<tr>
			<td class="head_c" rowspan="5" style="border-bottom:2px solid #000000;">NO</td>
			<td class="head_c" rowspan="5" style="border-bottom:2px solid #000000;" >성명</td>
			<td class="head_c" rowspan="5" style="border-bottom:2px solid #000000;" ><br>주민번호<br><br>입사일자</td>
			<td class="head_c" rowspan="3" >급여총액<br>(A + B + E)</td>
			<td class="head_c" rowspan="5" style="border-bottom:2px solid #000000;" >차인지급액</td>
			<td class="head_c" rowspan="5" style="border-bottom:2px solid #000000;" >근무일</td>
			<td class="head_c" colspan="13" >기본근무 / 초과근무</td>
			<td class="head_c" colspan="3" >4대보험</td>
			<td class="head_c" colspan="2" >소득세</td>
			<td class="head_c" colspan="<?=($addon_count[1] > $addon_count[2] ? $addon_count[1] : $addon_count[2])+2;?>" >지급수당</td>
		</tr>
		<tr>
			<td class="head_c" rowspan="2">합계(A)</td>
			<td class="head_c" colspan="2">기본시간</td>
			...
			<td class="head_c" rowspan="2">보전수당</td>
			<td class="head_c" rowspan="2">식대보조비</td>
			<td class="head_c" rowspan="4" style="border-bottom:2px solid #000000;">합계(C)</td>
			<td class="head_c" rowspan="2" >국민연금</td>
			<td class="head_c" rowspan="2" >장기요양</td>
			<td class="head_c" rowspan="4" style="border-bottom:2px solid #000000;">합계(D)</td>
			<td class="head_c" rowspan="2" >갑근세</td>
			<td class="head_c" rowspan="2">합계(E)</td>
			<td class="head_c" rowspan="2">직급수당</td>
			<?
				for($i=0; $i<$addon_count[1]; $i++){?>
					<td class="head_c" rowspan="2" ><?=($addon_caption[1][$i]['subject'] != '' ? $addon_caption[1][$i]['subject'] : '&nbsp;');?></td><?
				}
				if( $addon_count[1] < $addon_count[2]){
					$add_cnt = $addon_count[2] - $addon_count[1];

					for($j=1; $j<=$add_cnt; $j++){ ?>
						<td class="head_c" rowspan="2" ></td><?
					}
				}
			?>
		</tr>
		...
		<tr>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">공제총액<br>(C + D + F)</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">합계(B)</td>
			...
			<td class="head_c" colspan="2">휴야</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">차량유지비</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">년차수당</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">건강보험</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">고용보험</td>
			<td class="head_c" rowspan="2" style="border-bottom:2px solid #000000;">주민세</td>
			<td class="head_c" colspan="<?=($addon_count[2] > $addon_count[1] ? $addon_count[2] : $addon_count[1])+2;?>">공제항목</td>
		</tr>
		<tr>
			<td class="head_c" style="border-bottom:2px solid #000000;">시간</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">수당</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">시간</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">수당</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">시간</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">수당</td>
			...
			<td class="head_c" style="border-bottom:2px solid #000000;">시간</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">수당</td>
			<td class="head_c" style="border-bottom:2px solid #000000;">합계(F)</td>
			<td class="head_c" style="border-bottom:2px solid #000000;"></td>
			<?
				for($i=0; $i<$addon_count[2]; $i++){?>
					<td class="head_c" style="border-bottom:2px solid #000000;"><?=($addon_caption[2][$i]['subject'] != '' ? $addon_caption[2][$i]['subject'] : '&nbsp;');?></td><?
				}
		...
		?>
		<tr>
			<td class="head_c" style="border-bottom:2px solid #000000; font-weight:bold;" rowspan="2" colspan="3">합계</td>
			<td class="filed" style="font-weight:bold; BORDER-BOTTOM: black 0.5pt dashed" ><?=number_format($total_amt);?></td>
			<td class="filed_r" rowspan="2" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($diff_amt) != 0 ? number_format($diff_amt) : '';?></td>
			<td class="filed_c" rowspan="2" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($work_cnt) != 0 ? number_format($work_cnt) : '';?></td>
			<td class="filed" style="text-align:right; font-weight:bold; BORDER-BOTTOM: black 0.5pt dashed"><?=number_format($tot_basic_pay) != 0 ? number_format($tot_basic_pay) : '';?></td>
			<td class="filed" style="text-align:center; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($work_time, 1) != 0 ? number_format($work_time, 1) : '';?></td>
			<td class="filed" style="text-align:right; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($base_pay) != 0 ? number_format($base_pay) : '';?></td>
			<td class="filed" style="text-align:center; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($weekly_cnt) != 0 ? number_format($weekly_cnt) : '';?></td>
			<td class="filed" style="text-align:right; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($weekly_pay) != 0 ? number_format($weekly_pay) : '';?></td>
			<td class="filed" style="text-align:center; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($paid_cnt) != 0 ? number_format($paid_cnt) : '';?></td>
			...
			<td class="filed" style="text-align:center; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($bath_cnt) != 0 ? number_format($bath_cnt) : '';?></td>
			...
			<td class="filed" style="text-align:center; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($nursing_cnt) != 0 ? number_format($nursing_cnt) : '';?></td>
			...
			<td class="filed_r" rowspan="2" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($tot_ins_pay) != 0 ? number_format($tot_ins_pay) : '';?></td>
			...
			<td class="filed" style="text-align:right; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($tax_amt_1) != 0 ? number_format($tax_amt_1) : '';?></td>
			<td class="filed" style="text-align:right; font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($addon_pay_1) != 0 ? number_format($addon_pay_1) : '';?></td>
			...
			for($j=0; $j<$addon_count[1]; $j++){?>
				<td class="filed" style="font-weight:bold; border-bottom:black 0.5pt dashed;"><?=number_format($tot_addon[1][$addon_caption[1][$j]['index']])  != 0 ? number_format($tot_addon[1][$addon_caption[1][$j]['index']]) : '';?></td><?
			}
			...
			if( $addon_count[1] < $addon_count[2]){
				...
				$add_cnt = $addon_count[2] - $addon_count[1];
				for($j=1; $j<=$add_cnt; $j++){ ?>
					<td class="filed" style="font-weight:bold; border-bottom:black 0.5pt dashed;"></td><?
				}
			}?>

		</tr>
		<tr>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($deduct_amt) != 0 ? number_format($deduct_amt) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($tot_sudang_pay) != 0 ? number_format($tot_sudang_pay) : '';?></td>
			<td class="filed_c" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($prolong_hour) != 0 ? number_format($prolong_hour) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($prolong_pay) != 0 ? number_format($prolong_pay) : '';?></td>
			<td class="filed_c" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($night_hour) != 0 ? number_format($night_hour) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($night_pay) != 0 ? number_format($night_pay) : '';?></td>
			<td class="filed_c" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($holiday_hour) != 0 ? number_format($holiday_hour) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($holiday_pay) != 0 ? number_format($holiday_pay) : '';?></td>
			<td class="filed_c" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($holiday_prolong_hour) != 0 ? number_format($holiday_prolong_hour) : '';?></td>
			...
			<td class="filed_c" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($holiday_night_hour) != 0 ? number_format($holiday_night_hour) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($holiday_night_pay) != 0 ? number_format($holiday_night_pay) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($car_keep_pay) != 0 ? number_format($car_keep_pay) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><!--<?=number_format($car_keep_pay) != 0 ? number_format($car_keep_pay) : '';?>--></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($health_amt) != 0 ? number_format($health_amt) : '';?></td>
			...
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($tax_amt_2) != 0 ? number_format($tax_amt_2) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($addon_pay_2) != 0 ? number_format($addon_pay_2) : '';?></td>
			<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"></td><?
			for($j=0; $j<$addon_count[2]; $j++){?>
				<td class="filed_r" style="border-bottom:2px solid #000000; font-weight:bold;"><?=number_format($tot_addon[2][$addon_caption[2][$j]['index']]) != 0 ? number_format($tot_addon[2][$addon_caption[2][$j]['index']]) : '';?></td><?
			}
			if( $addon_count[2] < $addon_count[1]){
				$add_cnt = $addon_count[1] - $addon_count[2];
		...
		for($i=0; $i<$mem_cnt; $i++){?>
			<tr>
				<td class="head_c" rowspan="2"  style="border-bottom:1pt solid #000000;"><?=$i+1;?></td>
				<td class="head_c" rowspan="2"  style="border-bottom:1pt solid #000000;"><?=$mem[$i]['member_nm'];?></td>
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=substr($mem[$i]['member_cd'],0,6);?>-<?=substr($mem[$i]['member_cd'],6,7);?></td>	
				...
				<td class="filed_c" rowspan="2" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['work_cnt']);?></td>
				...
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=number_format($mem[$i]['work_time'], 1) != 0 ? number_format($mem[$i]['work_time'], 1) : ''; ?></td>
				...
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=number_format($mem[$i]['weekly_cnt']) != 0 ? number_format($mem[$i]['weekly_cnt']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=number_format($mem[$i]['paid_cnt']) != 0 ? number_format($mem[$i]['paid_cnt']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=number_format($mem[$i]['bath_cnt']) != 0 ? number_format($mem[$i]['bath_cnt']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:black 0.5pt dashed;"><?=number_format($mem[$i]['nursing_cnt']) != 0 ? number_format($mem[$i]['nursing_cnt']) : '';?></td>
			...
			<tr>
				...
				<td class="filed_c" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['prolong_hour']) != 0 ? number_format($mem[$i]['prolong_hour']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['night_hour']) != 0 ? number_format($mem[$i]['night_hour']) : '';?></td>
				<td class="filed_r" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['night_pay']) != 0 ? number_format($mem[$i]['night_pay']) : '';?></td>
				<td class="filed_c" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['holiday_hour']) != 0 ? number_format($mem[$i]['holiday_hour']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['holiday_prolong_hour']) != 0 ? number_format($mem[$i]['holiday_prolong_hour']) : '';?></td>
				...
				<td class="filed_c" style="border-bottom:1pt solid #000000;"><?=number_format($mem[$i]['holiday_night_hour']) != 0 ? number_format($mem[$i]['holiday_night_hour']) : '';?></td>
