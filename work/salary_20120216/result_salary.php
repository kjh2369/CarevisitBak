<?
	...
	for($i=0; $i<$mem_count; $i++){
		...
		case 3: //월급
			...
			if ($debug){
				if ($jumin == '4705062063314' || $jumin == '4810032036616'){
					echo '1<br>';
					echo $sql;
					echo '<br>---------------------------------------------------------------------------------------<br>';
				}
		...
		if ($member[$i]['family_yn'] == 'Y'){
			...
			if ($debug){
				if ($jumin == '4705062063314' || $jumin == '4810032036616'){
					echo $member[$i]['family_yn'].'/'.$member[$i]['family_type'];
					echo '<br>---------------------------------------------------------------------------------------<br>';
				}
			}
		...
		$sql = "insert into salary_basic values (
				...
				,'".($member[$i]['normal_work_cnt']+$member[$i]['family_work_cnt']+$member[$i]['normal_holiday_cnt']+$member[$i]['family_holiday_cnt'])."'
