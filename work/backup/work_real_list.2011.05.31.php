...
<?
if ($mKind == 'all'){ ?>
<th class="head" rowspan="2">요양기관</th><?
} ?>
...
<th class="head" rowspan="2">
	<div style="width:auto;" class="help_left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;요양보호사</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;성명</div>
...
<th class="head" rowspan="2">
	<div style="width:auto;" class="help_left">&nbsp;&nbsp;&nbsp;&nbsp;진행</br>&nbsp;&nbsp;&nbsp;&nbsp;상태</div>
	<div class="help" onmouseover="_show_help(this, '녹색완료는 스마트폰으로 정상완료를 한 경우이며, 클릭시 상세서비스항목이 표시됩니다. 적색완료는 수동으로 입력하여 완료한 경우 입니다.');" onmouseout="_hidden_help();">&nbsp;</div>
</th>
</th>
...
<?
	...
	if ($mStat != 'all'){
		if ($mStat == '9' || $mStat == '0'){
			$sql .= " and case when t01_status_gbn = '9' and concat(t01_sugup_date, t01_sugup_fmtime) <= date_format(now(), '%Y%m%d%H%i') then '0' else t01_status_gbn end = '".$mStat."'";
		}else{
