...
<?
	if ($mode == 1){?>
		...
		<div style="width:80px; margin:10px -5px 0 0; padding:6px; border:2px solid #cccccc; background-color:#fbfbfb; text-align:center; font-weight:bold;">
			<span class="btn_pack m"><button type="button" onclick="save(1);">확인</button></span>
		</div>
		<div style="margin:10px; text-align:left; font-weight:bold;">
			...
			<span style="padding-left:19px;">이전에 계산된 청구 금액 및 급여금액이 서로 다를 수 있으니 주의하시기 바랍니다.(재 확정 필요)</span><br>
			<span>※ 실적마감 처리 후 수급자 수급실적을 일괄 확정 하여야 합니다.</span><br>
		</div><?
	}else{?>
