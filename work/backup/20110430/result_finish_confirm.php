...
<div style="width:120px; margin:10px 0 0 10px; padding:5px; border:2px solid #cccccc; background-color:#efefef; text-align:center; font-weight:bold;">실적 일괄 확정</div>
...
<?
	if ($mode == 1){?>
		...
		<div style="width:60px; margin:20px -5px 0 10px; padding:6px; border:2px solid #cccccc; background-color:#fbfbfb; text-align:center; font-weight:bold;">
			<span class="btn_pack m"><button type="button" onclick="save(1);">예약일자 저장</button></span>
		</div>

		<div style="text-align:left;">
			<div style="width:60px; margin:20px -5px 0 10px; padding:6px; border:2px solid #cccccc; background-color:#fbfbfb; text-align:center; font-weight:bold;">
				<span class="btn_pack m"><button type="button" onclick="_work_confirm('<?=$code;?>','<?=$year;?>','<?=$month;?>',1);" style="font-weight:bold;">실적일괄확정 수동실행</button></span>
			</div>
		</div>
		...
		<div style="width:60px; margin:20px -5px 0 10px; padding:6px; border:2px solid #cccccc; background-color:#fbfbfb; text-align:center; font-weight:bold;">
			<span class="btn_pack m"><button type="button" onclick="save(2);">예약일자 저장</button></span>
		</div>

		<div style="text-align:left;">
			<div style="width:60px; margin:20px -5px 0 10px; padding:6px; border:2px solid #cccccc; background-color:#fbfbfb; text-align:center; font-weight:bold;">
				<span class="btn_pack m"><button type="button" onclick="_work_confirm('<?=$code;?>','<?=$year;?>','<?=$month;?>',2);" style="font-weight:bold;">자동급여계산 수동실행</button></span>
			</div>
		</div>

		<div style="margin:10px; text-align:left; font-weight:bold;">
			<span>※ 요양보호사별 급여 내역을 일괄 계산합니다.</span><br>
			<span>※ 요양보호사 개인별 계산된 내역은 무시되고 전체 일괄계산합니다.</span>
		</div><?
	}
?>
