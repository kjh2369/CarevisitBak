<?
	...
	$year	= $_POST['year'];
	$month	= ($_POST['month'] < 10 ? '0' : '').$_POST['month'];
	...
	*/
	...
	$conf_dt	= $_POST['conf_y'].'-'.$_POST['conf_m'].'-'.$_POST['conf_d'];
	$calc_dt	= $_POST['calc_y'].'-'.$_POST['calc_m'].'-'.$_POST['calc_d'];
...
<script language='javascript'>
	...
	location.replace("result_finish_confirm.php?mode=<?=$_POST['mode'];?>&year=<?=$_POST['year'];?>&month=<?=$_POST['month'];?>");
</script>