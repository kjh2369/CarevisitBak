<?
	...
	#
		...
		for($i=0; $i<$rowCount; $i++){
			...
			if (!Empty($laLimit[$row['jumin']])){
				$row['kupyeo_max'] = $laLimit[$row['jumin']];
			}
			...
			if ($client[$i]['kind'] == '0' && $laOption[$client[$i]['jumin']]['limit_yn'] == 'N'){
				...
				$sql = "select *
						 ...
						 where t01_ccode               = '".$client[$i]['code']."'
						   ...
						   and t01_del_yn              = 'N'
						 order by t01_svc_subcode DESC, t01_sugup_date, t01_sugup_fmtime, t01_sugup_totime";
