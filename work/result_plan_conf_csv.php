...
function set_csv(){
	...
	window.open('', 'CSV_WINDOW', 'width=600, height=300, scrollbars=no, resizable=no');
...
<form name="f" method="post" action="result_plan_conf_csv_upload.php" enctype="multipart/form-data" target="CSV_WINDOW">

<div class="title title_border">건보 계획, 실적 등록(TEXT)</div>
