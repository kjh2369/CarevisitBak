<?
	...
	$sheet->getColumnDimension('E')->setWidth(12); //이용자수
	$sheet->getColumnDimension('F')->setWidth(12); //서비스횟수
	...
	$sheet->SetData( Array('F'=>'A'.$rowNo, 'T'=>'F'.$rowNo, 'val'=>$title, 'bold'=>true, 'border'=>'TNRNBNLN') );
	...
	$rowNo ++;
	$sheet->getRowDimension($rowNo)->setRowHeight($rH);
	$sheet->SetData( Array('F'=>'A'.$rowNo, 'T'=>'C'.$rowNo, 'val'=>'조회기간 : '.$myF->dateStyle($fromDt, '.').' ~ '.$myF->dateStyle($toDt, '.'), 'H'=>'L', 'border'=>'TNRNBNLN') );
	$sheet->SetData( Array('F'=>'D'.$rowNo, 'T'=>'F'.$rowNo, 'val'=>'출력일 : '.Date('Y.m.d'), 'H'=>'R', 'border'=>'TNRNBNLN') );
	...
	$sheet->SetData( Array('F'=>'E'.$rowNo, 'val'=>'이용자수', 'backcolor'=>'EEECE1') );
	$sheet->SetData( Array('F'=>'F'.$rowNo, 'val'=>'서비스횟수', 'backcolor'=>'EEECE1') );
