...
<body>
	<div id="wrap">
	<!-- 참가신청-->
	<h2><img src="./img/re_top_title.png" alt="공동구매 신청하기"/></h2>
	<div class="bank">
	 <h3><img src="./img/re_title1.png" alt="이체 금액 및 계좌안내" class="mg_top18 mg_left28"/></h3>
	 <p class="mg_left28">
	  <strong style="display:block; color:#fff; font-size:14px;">- 금액 : <span id="txtPay" style="font-size:14px; color:#fff;"></span>&nbsp;원</strong>
	  <strong style="display:block; color:#fff;  font-size:14px; margin-top:5px;">- 농협 : 302-0983-1868-41&nbsp;&nbsp;&nbsp;&nbsp;예금주 : 이 양 수 </strong>
	 <p>
	</div>
  ...
  <h3><img src="./img/re_title2.png" alt="신청서작성" class="mg_top18 mg_left28"/></h3>
	...
	<input type="hidden" id="txtBoardPay" name="txtBoardPay" value=""/>
		<table  class="write_type mg_top10" border="1" cellspacing="0" summary="">
			...
			<tbody>
				<tr>
					<th scope="row"><label for="BoardRank" style="font-size:14px; font-weight:bold">신청대수</label></th>
					<td style="font-size:14px; font-weight:bold"><input type="text" id="BoardRank" name="BoardRank" style="width:10%; font-size:14px;" onkeyup="lfSetPay();" value="1" />&nbsp;대</td>
				</tr>
				<tr>
					<th scope="row"><label for="BoardPay" style="font-size:14px; font-weight:bold">금액</label></th>
					<td style="font-size:14px; font-weight:bold"><span id="BoardPay" style="width:50px; padding-right:5px; font-size:14px; font-weight:bold; color:#faf717;"></span>원</td>
				</tr>
			</tbody>
		</table>
