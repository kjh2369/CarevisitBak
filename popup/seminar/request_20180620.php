...
<body>
  ...
  <img src="./img/all2.png" alt="신청서작성" />
	...
	<input type="hidden" id="txtBoardPay" name="txtBoardPay" value=""/>
		<table  class="write_type mg_top10 mg_left25" border="1" cellspacing="0" summary="">
			...
			<tbody>
				<tr>
					<th scope="row"><label for="BoardName" style="font-size:14px; font-weight:bold">참석자</label></th>
					<td style="font-size:14px; font-weight:bold">
						<input type="text" id="BoardName" name="BoardName" style="width:50%; font-size:14px; ime-mode:active;" value="<?=$mst['name'];?>" />
					</td>
				</tr>
				<tr>
		...
		<div style="text-align:center; width:460px; padding-top:10px; color:red; font-weight:bold; font-size:15pt;">
